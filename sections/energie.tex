...
\begin{figure}[H]
	\centering
	\subfloat[B-Feld-Plot des Ferritkerns ]{\includegraphics[width=0.7\linewidth]{flyback_v3_spule1}}\qquad
	\subfloat[Farbskala in Tesla]{\includegraphics[width=0.7\linewidth]{flyback_v3_spule2}}
	\caption{Speichertransformator mit 0.1mm Abstand}
	\label{fig:spule}
\end{figure}
...
\begin{figure}[H]
	\centering
	\subfloat[B-Feld-Plot des Ferritkerns ]{\includegraphics[width=0.6\linewidth]{flyback_v3_spule2}}\qquad
	\subfloat[Farbskala in Tesla]{\includegraphics[width=0.6\linewidth]{flyback_ohne}}
	\caption{Speichertransformator mit 0.1mm Abstand}
