...
\newpage
\paragraph{Störlicht}
Alle Messungen wurden bei Tageslicht und Sonneneinstrahlung durchgeführt. Dabei wurden keine Unregelmässigkeiten registriert, welche vom Umgebungslicht stammen könnten. Da der Dosenverschliesser in einem Gebäude eingesetzt wird und durch die Konstruktion kaum Licht in die Schaltung eindringen wird, kann die Schaltung als störsicher gegen Umgebungslicht eingestuft werden.
